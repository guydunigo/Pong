...
class Circle : public Shape {
	...
	public:
		...
		inline int getPoints(void) const {
			return points;
		}
		inline void setRotZ(float val) {
    		rotZ = val;
		}
		...
		virtual void step(float, float, float, std::vector<Rectangle*> &, std::vector<Circle*> &, std::vector<Triangle*> &, float, float);
