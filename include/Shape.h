...
class Shape {
  ...
  public:
    ...
    inline float getX(void) const { return pos[0]; }
    inline float getY(void) const { return pos[1]; }
    inline float getCelX(void) const { return cel[0]; }
    inline float getCelY(void) const { return cel[1]; }
    inline float getMass(void) const { return mass; }
    inline Color &getColor(void) { return color; }
    inline void setX(float val) { pos[0] = val; }
    inline void setY(float val) { pos[1] = val; }
    inline void setCelX(float val) { cel[0] = val; }
    inline void setCelY(float val) { cel[1] = val; }
